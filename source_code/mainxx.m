...
% More information about the input arguments of the functions can be found in Qsynth.m
%
% MATLAB R2017a
% (c) Copyright 2017, Robin Schwemmle <robin.schwemmle@venus.uni-freiburg.de>

tic
for j = 1:20 % number of time series that are generated
    ...
    Qsyn.folderres(['/Users/robinschwemmle/Desktop/MATLAB/Qsynth/results/inverliever/AR/1_20/' num2str(j)]);
    ...
    for i = 1:l
        clusters{1,i} = Qsynth();
        clusters{1,i}.folderres(['/Users/robinschwemmle/Desktop/MATLAB/Qsynth/results/inverliever/AR/1_20/' num2str(j) '/' num2str(i)]);
    ...
    [val, idx] = min(opt_val);
    clusters{1,idx}.dir_results = ['/Users/robinschwemmle/Desktop/MATLAB/Qsynth/results/inverliever/AR/1_20/' num2str(j)];
    ...
    dlmwrite(['/Users/robinschwemmle/Desktop/MATLAB/Qsynth/results/inverliever/AR/1_20/' num2str(j) '/opt_val.txt'], opt_val, 'delimiter', '\t', 'precision', 3);
